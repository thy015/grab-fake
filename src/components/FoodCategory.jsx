...
function FoodCategory() {
  return (//its supposed to be reuseable but im just new here 
    <div className="container-food container-md">
      <div className="row row-card">
        <div className="col-sm" style={{ width: "23.3333%" }}>
        ...
        <div className="col-sm-3" >
          <div className="card border-0 last-card">
            ...
            />
            <div className="card-body">
              <h5 className="card-title">Bún bò Huế</h5>
            </div>
          </div>
        </div>
      </div>
